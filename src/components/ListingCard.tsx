...
function ListingCard({listing}: {listing:ListingType}) {
    ...
    return (
      <div className="max-w-sm rounded overflow-hidden shadow-lg bg-white hover:scale-105 transition-all duration-500 cursor-pointer">
